...
interface IMulticall3ContractInterface extends ethers.utils.Interface {
  functions: {
...
export class IMulticall3Contract extends Contract {
  ...
  interface: IMulticall3ContractInterface;
